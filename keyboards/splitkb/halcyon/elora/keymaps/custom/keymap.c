...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	[_SYMBACNT] = LAYOUT_elora_hlc(
		_______ , _______ , BR_MORD , _______ , BR_FORD , _______ ,                                         XXXXXXX , BR_ACUT , BR_CIRC , BR_TILD , XXXXXXX , XXXXXXX ,
		_______ , MC_Icute, MC_Ocirc, MC_Ecirc, MC_Acirc, XXXXXXX ,                                         BR_DEG  , KC_UNDS , KC_HASH , KC_AT   , XXXXXXX , XXXXXXX ,
		_______ , MC_Ucute, MC_Ocute, MC_Ecute, MC_Acute, MC_Icute,                                         KC_DLR  , MY_QUES , KC_EXLM , BR_SLSH , XXXXXXX , XXXXXXX ,
	 ...
	 * |---------+-------+-------+-------+-------+-------|                                     |--------+-------+-------+-------+-------+-------|
	 * | _______ |   K   |   %   | Ctl/H | Sft/: |  _e_  |                                     |   /    |   4   |   5   |   6   |   -   | _____ |
	 * |---------+-------+-------+-------+-------+-------+---------------.  ,------------------+--------+-------+-------+-------+-------+-------|
	...
	[_NUMPAD] = LAYOUT_elora_hlc(
		...
		_______ , KC_K    , KC_PERC , MY_H    , MY_COLN , MC_E    ,                                         KC_PSLS , KC_4    , KC_5    , KC_6    , KC_PMNS , _______ ,
	...
	[_SHORTCUTS] = LAYOUT_elora_hlc(
		_______ , _______ , _______ , _______ , XXXXXXX , XXXXXXX ,                                         XXXXXXX , KC_INS  , _______ ,C(KC_PSCR),_______ , _______ ,
	...
	[_MACROS] = LAYOUT_elora_hlc(
		...
		_______ , _______ , XXXXXXX , XXXXXXX , XXXXXXX , XXXXXXX ,                                         XXXXXXX , MC_cutey, MC_doubt, MC_link , XXXXXXX , XXXXXXX ,
		_______ , XXXXXXX , XXXXXXX , XXXXXXX , XXXXXXX , _______ ,                                         MC_squez, MC_tired, MC_break, MC_rqv  , XXXXXXX , XXXXXXX ,
